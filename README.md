...
## Всего выполнено 19 тестов:
## Выполнено 8 юнит-тестов (5 + 3), 6 интеграционных тестов (3 + 3 UI), 2 теста на проверку Flow (1 + 1 нетривиальный), 4 нетривиальных теста (2 + 1)
<h3> Юнит-тесты </h3>
<h4> ListViewModel: </h4>
